var grades = [];
        var update_scores = function () {
           ...
           // Agrega el nombre de identificacion apropiado para leer los puntajes, nombre_alumno, puntaje, nombre_alumno
           var val =gat_item_list(grades);
           document.getElementById("puntajes").value = val;
           document.getElementById("nombre_del_alumno").value = "";
           document.getElementById("puntaje").value = "";
           document.getElementById("nombre_del_alumno").focus();
        }    
        ...
        {
            // Agrega la funcion sort() para ordenar a los alumnos por su nombre
        grades.sort_click();
        update_scores();
        }
